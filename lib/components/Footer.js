...
function Footer(_ref) {
  var caption = _ref.caption,
      ...
      props = _objectWithoutProperties(_ref, ['caption', 'countCurr', 'countSeparator', 'countTotal', 'showCount', 'theme', 'actionElement']);
...
Footer.propTypes = {
  ...
  actionElement: _propTypes2.default.element
};
