...
var ImgsViewer = function (_Component) {
  ...
  function ImgsViewer(props) {
    ...
    _this.state = { imgLoaded: false, footerRendered: false };
  ...
  _createClass(ImgsViewer, [{
    ...
    value: function handleImgLoaded() {
      ...
      this.setState({ footerRendered: true })
    ...
    value: function renderDialog() {
      ...
      var viewer = _react2.default.createElement(
    ...
    value: function renderFooter(theme) {
      var _props6 = this.props,
          ...
          actionElement = _props6.actionElement,
